...
module k2016Game {
    export class Gamewin extends Phaser.State {
        ...
        create() {
            ...
            let _del:Phaser.Sprite=this.game.add.sprite(570, 390, 'delGameover');
            _del.anchor.set(.5);
            _del.frame=3;
            ...
            let _win1:Phaser.Sprite=this.game.add.sprite(480, 430, 'winners');   
            _win1.anchor.set(.5);         
        ...
        /*    this.btnBlue = this.game.add.sprite(900, 90, "btnBlue");
           ...
           let _anonymous = getUrlParameter("anonymous") ? true : false;
